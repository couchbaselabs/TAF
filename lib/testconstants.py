...
COUCHBASE_FROM_4DOT6 = ["4.6.0", "4.6.1", "4.6.2", "4.6.3", "4.6.4", "4.6.5",
                        ...
                        "7.0.0", "7.0.1", "7.0.2", "7.0.3", "7.0.4", "7.1.0",
                        "7.1.1", "7.2.0"]
COUCHBASE_FROM_WATSON = ["0.0.0", "4.5.0", "4.5.1", "4.6.0", "4.6.1", "4.6.2",
                         ...
                         "7.0.3", "7.0.4", "7.1.0", "7.1.1", "7.2.0"]
"""
    If new version is greater than 5.0.0, we need to add new version 
    to constant COUCHBASE_FROM_SPOCK below so that windows will get correct 
    build (msi) to un/install
"""
...
COUCHBASE_FROM_VULCAN = ["0.0.0", "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.5.4",
                         ...
                         "7.0.1", "7.0.2", "7.0.3", "7.0.4", "7.1.0", "7.1.1",
                         "7.2.0"]
