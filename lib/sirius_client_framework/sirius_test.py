...
from sirius_client_framework.multiple_database_config import MongoLoader, CouchbaseLoader, CassandraLoader, MySQLLoader, \
    DynamoDBLoader
from sirius_client_framework.operation_config import WorkloadOperationConfig
from Jython_tasks.sirius_task import WorkLoadTask, DatabaseManagementTask, BlobLoadTask
...
class SiriusTest(CouchbaseBaseTest):
    def setUp(self):
        ...
        self.cassandra_connection_string = self.input.param("cassandra_url", "cassandra://127.0.0.1:9091")
        ...
        self.dynamo_connection_string = self.input.param("dynamo_url", "dynamo://127.0.0.1:8091")
        ...
        self.mysql_connection_string = self.input.param("mysql_url", "mysql://127.0.0.1:8091")
