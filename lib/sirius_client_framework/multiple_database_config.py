...
class CouchbaseLoader(DB):
    def __init__(
        ...
        """
        super(CouchbaseLoader, self).__init__(username, password, connection_string,
...
class MongoLoader(DB):
    def __init__(
        ...
        """
        super(MongoLoader, self).__init__(username, password, connection_string,
...
class ColumnarLoader(DB):
    def __init__(
        ...
        """
            ...
            :param sdk_batch_size: Batch size for bulk CRUD operations. (int, optional)
        """
        super(ColumnarLoader, self).__init__(username, password, connection_string,
...
class MySQLLoader(DB):
    def __init__(
        ...
        """
            ...
            :param sdk_batch_size: Batch size for bulk CRUD operations. (int, optional)
        """
        super(MySQLLoader, self).__init__(username, password, connection_string,
...
class DynamoDBLoader(DB):
    def __init__(
        ...
        """
        super(DynamoDBLoader, self).__init__(username, password, connection_string,
