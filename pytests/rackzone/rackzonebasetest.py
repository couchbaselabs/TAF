...
from testconstants import LINUX_COUCHBASE_BIN_PATH, WIN_COUCHBASE_BIN_PATH, MAC_COUCHBASE_BIN_PATH
...
class RackzoneBaseTest(BaseTestCase):
    ...
    def tearDown(self):
        ...
        self.cluster_util.cleanup_cluster(self.servers, master=self.cluster.master)
