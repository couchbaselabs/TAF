...
# 10k-collection variant of maxTTL.collections_with_ttl.
#
...
# num_items at bucket level, so every generated collection preloads 1000 docs
# - roughly 4M in total - and the spec load then runs for minutes, far longer
# than the 100s collection maxTTL below, so docs expire mid-load and the
    ...
    "buckets": {
        "default": {
            ...
            "scopes": {
                ...
                # maxTTL (0) and hold the docs expected to remain once the
                # TTL-bearing collections above have expired.
                "scope3": {
                    "privileges": [
                        "Perm1"
                    ],
