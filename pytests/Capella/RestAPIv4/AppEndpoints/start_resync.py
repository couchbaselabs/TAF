...
class PostResync(GetAppEndpoints):

    def setUp(self, nomenclature="Resync_Post"):
    ...
    def tearDown(self):
        super(PostResync, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/resync",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/resyn",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/resync/resyn",
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.postAppEndpointResync = \
                    testcase["url"]
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis.start_resync(
                    ...
                    appEndpointName, self.expected_res["scopes"])
            self.capellaAPI.cluster_ops_apis.postAppEndpointResync = \
    ...
    def test_payload(self):
        ...
        for k in self.expected_res:
            for v in [
                ...
                testcase[k] = v
                testcase["desc"] = "Testing `{}` with val: `{}` of {}".format(
                    k, v, type(v))
                if (k == "scopes" and
                        (isinstance(v, dict) or isinstance(v, type(None)))):
                    continue
                testcase["expected_status_code"] = 400
                testcase["expected_error"] = {
                    "code": 1000,
                    ...
                    "message": "Bad Request. Error: body contains "
                               "incorrect JSON type for field \"scopes\"."
                }
        ...
        for testcase in testcases:
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis.start_resync(
                    ...
                    self.app_service_id, self.appEndpointName,
                    testcase["scopes"])
            self.validate_testcase(result, [202, 412], testcase, failures,
                                   payloadTest=True)
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.start_resync, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                self.expected_res["scopes"]
            )
