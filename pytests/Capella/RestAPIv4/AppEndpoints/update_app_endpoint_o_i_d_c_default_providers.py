...
class PutDefaultProvider(GetOidcProviders):
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders/defaultProvider",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders/defaultProvide",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders/defaultProvider/defaultProvide",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        failures = list()
        temporary_OIDC_Provider = self.create_app_endpoint_oidc_Provider_to_be_tested(
                self.app_service_id, self.appEndpointName, self.expected_res["data"][1])
        turn = True
        for testcase in testcases:
            ...
            oidcProviderId = temporary_OIDC_Provider if turn else self.OIDCProvider_id

            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.default_provider_endpoint = \
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.update_app_endpoint_o_i_d_c_default_provider(
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis.update_app_endpoint_o_i_d_c_default_provider(
                    ...
                    **oidc_overrides)
            self.capellaAPI.cluster_ops_apis.default_provider_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders/defaultProvider"
            if self.validate_testcase(result, [204], testcase, failures):
                turn = not turn

        self.flush_oidcProviders(self.project_id, self.cluster_id,self.app_service_id, self.appEndpointName, temporary_OIDC_Provider)
    ...
    def test_authorization(self):
        ...
        for testcase in self.v4_RBAC_injection_init([
            ...
            param = dict()
            param["providerId"] = self.OIDCProvider_id
            result = self.capellaAPI.cluster_ops_apis.update_app_endpoint_o_i_d_c_default_provider(
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            self.log.info("Executing test: {}".format(testcase["description"]))
            kwarg = {testcase["param"]: testcase[
                "paramValue"]} if "param" in testcase else dict()

            kwarg["providerId"] = self.OIDCProvider_id
    ...
    def test_payload(self):
        temporary_OIDC_Provider = self.create_app_endpoint_oidc_Provider_to_be_tested(
                self.app_service_id, self.appEndpointName, self.expected_res["data"][1])
        testcases = list()
        for k in self.expected_res["data"][0]:
            if k in ["clientId", "discoveryUrl", "isDefault", "issuer",
                     "register", "rolesClaim", "userPrefix", "usernameClaim"]:
                continue
            ...
            for v in [
                ...
                temporary_OIDC_Provider, self.OIDCProvider_id
            ]:
                testcase = deepcopy(self.expected_res["data"][0])
                testcase[k] = v
                for param in ["clientId", "discoveryUrl", "isDefault", "issuer",
                     "register", "rolesClaim", "userPrefix", "usernameClaim"]:
                    del testcase[param]
                ...
                if type(v) == str or v is None:
                    ...
                    testcase["expected_error"] = {
                        ...
                        "httpStatusCode": 422,
                        "message": "OIDC provider invalid name"
                    }
                elif type(v) in [int, float, list, dict]:
                    testcase["expected_status_code"] = 400
                    testcase["expected_error"] = {
                        "code": 1000,
                        "hint": "The request was malformed or invalid.",
                        "httpStatusCode": 400,
                        "message": "Bad Request. Error: body contains incorrect JSON type for field \"{}\".".format(k)
                    }
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.update_app_endpoint_o_i_d_c_default_provider, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                self.expected_res["providerId"]
            )
        ]]
