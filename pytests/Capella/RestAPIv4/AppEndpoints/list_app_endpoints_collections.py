...
@author: Created using cbRAT cbFile by ramesh
"""
...
class ListAppEndpointsCollections(GetAppEndpoints):

    def setUp(self, nomenclature="ListAppEndPointCollections"):
    ...
    def tearDown(self):
        super(ListAppEndpointsCollections, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/collections",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/collections/collection",
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.app_endpoint_collections_endpoint = \
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_collections(
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_collections(
                    organization, project, cluster, appService, AppEndpointName)
            self.capellaAPI.cluster_ops_apis.app_endpoint_collections_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/collections"
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_collections(self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                **kwarg)
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.list_app_endpoint_collections, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
