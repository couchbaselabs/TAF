...
class DeleteAppEndpoints(GetAppEndpoints):

    def setUp(self, nomenclature="AppEndpoints_DELETE"):
        GetAppEndpoints.setUp(self, nomenclature)

    def tearDown(self):
        super(DeleteAppEndpoints, self).tearDown()
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.delete_app_endpoint, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
