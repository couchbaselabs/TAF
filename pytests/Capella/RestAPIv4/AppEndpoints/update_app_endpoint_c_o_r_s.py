"""
Created on May 07, 2025 Midnight

@author: ramesh
"""

from pytests.Capella.RestAPIv4.AppEndpoints.get_import_filters import GetImportFilter
from copy import deepcopy

class PutCors(GetImportFilter):

    def setUp(self, nomenclature="ConnectOIDCProviders_PUT"):
        GetImportFilter.setUp(self, nomenclature)

    def tearDown(self):
        super(PutCors, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/cors",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/cor",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/cors/cor",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.cors_endpoint = \
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.update_cors(
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis.update_cors(
                    ...
                    self.expected_res["cors"])
            self.capellaAPI.cluster_ops_apis.cors_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/cors"
                ...
                if (combination[0] == "" or combination[1] == "" or
                    ...
                    testcase["expected_error"] = {
                        ...
                        "message": "Unable to process the request. The "
                                   ...
                                   "the cluster {}.".format(combination[1], combination[2])
                    }
    ...
    def test_payload(self):
        testcases = list()
        for k in self.expected_res["cors"]:
            if k in []:
                continue
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.update_cors,(
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                self.expected_res["cors"]
            )
