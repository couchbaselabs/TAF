...
class DeleteActivationStatus(GetAppEndpoints):
        ...
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/activationStatus",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/activationStatu",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/activationStatus/activationStatu",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
    ...
    def test_query_parameters(self):
        self.log.debug(
                ...
                "appEndpointName: {}".format(
                    self.organisation_id, self.project_id, self.cluster_id,
                    self.appEndpointName, self.appEndpointName))
        testcases = 0
        failures = list()
        for combination in self.create_path_combinations(
            ...
            if not (combination[0] == self.organisation_id and
                    ...
                    combination[3] == self.appEndpointName and
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.pause_app_endpoint, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
