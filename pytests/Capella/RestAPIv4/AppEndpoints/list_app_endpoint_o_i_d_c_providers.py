...
class ListOidcProviders(GetOidcProviders):

    def setUp(self, nomenclature="ConnectOIDCProviders_LIST"):
    ...
    def tearDown(self):
        super(ListOidcProviders, self).tearDown()
    ...
    def test_api_path(self):
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_o_i_d_c_providers(
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.list_app_endpoint_o_i_d_c_providers, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
