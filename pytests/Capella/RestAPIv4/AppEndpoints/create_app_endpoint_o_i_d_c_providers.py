...
class PostOidcProviders(GetOidcProviders):

    def __init__(self, methodName="runTest"):
        super(PostOidcProviders, self).__init__(methodName)
        self.bucket_id = None

    def setUp(self, nomenclature="ConnectOIDCProviders_POST"):
        GetOidcProviders.setUp(self, nomenclature)

    def tearDown(self):
        super(PostOidcProviders, self).tearDown()
    ...
    def test_api_path(self):
        ...
        for testcase in testcases:
            ...
            if "invalid_organizationId" in testcase:
                ...
                appServiceId = testcase["invalid_appServiceId"]
            elif "invalid_appEndpointName" in testcase:
                appEndpointName = testcase["invalid_appEndpointName"]

            result = self.capellaAPI.cluster_ops_apis.create_app_endpoint_o_i_d_c_provider(
                organization, project, cluster, appServiceId, appEndpointName,
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            if not (combination[0] == self.organisation_id and
                ...
                if (combination[0] == "" or combination[1] == "" or combination[2] == "" or
                        combination[3] == ""):
                    ...
                    testcase["expected_error"] = {
                        ...
                        "hint": "Please review your request and ensure that "
                                ...
                                "provided.",
                        "message": "AppServiceID is invalid.",
                        "httpStatusCode": 400
                    }
    ...
    def test_payload(self):
        ...
        for k in self.expected_res["data"][0]:
            ...
            for v in [
                ...
                for param in []:
                    del testcase[param]
                # Create a proper payload dictionary
                test_data = {
                    "description": "Testing `{}` with val: `{}` of {}".format(
                        k, v, type(v))
                }
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.create_app_endpoint_o_i_d_c_provider, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                self.expected_res["data"][1]["issuer"],
                self.expected_res["data"][1]["clientId"]
            )
        ]]
