...
from pytests.Capella.RestAPIv4.AppEndpoints.get_app_endpoint_o_i_d_c_providers import GetOidcProviders
from copy import deepcopy


class PutOidcProviders(GetOidcProviders):

    def setUp(self, nomenclature="ConnectOIDCProviders_PUT"):
        GetOidcProviders.setUp(self, nomenclature)

    def tearDown(self):
        super(PutOidcProviders, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProvider",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders/oidcProvider",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                ...
                "description": "Call API with non-hex OIDCProviderId",
                "invalid_OIDCProviderId": self.replace_last_character(
                    self.OIDCProvider_id, non_hex=True),
                "expected_status_code": 400,
                "expected_error": {
                    "code": 1000,
                    "hint": "Check if you have provided a valid URL and all "
        ...
        for testcase in testcases:
            ...
            OIDCProvider = self.OIDCProvider_id

            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.app_endpoint_OIDC_provider = \
                    testcase["url"]
            ...
            elif "invalid_OIDCProviderId" in testcase:
                OIDCProvider = testcase["invalid_OIDCProviderId"]

            result = self.capellaAPI.cluster_ops_apis.update_app_endpoint_o_i_d_c_provider(
                organization, project, cluster, appService,
                appEndpointName, OIDCProvider,
                **self.expected_res["data"][1]
            )
            ...
            self.capellaAPI.cluster_ops_apis.app_endpoint_OIDC_provider = \
                "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/oidcProviders"
    ...
    def test_query_parameters(self):
        self.log.debug(
            ...
            "appEndpointNa ID: {}, OIDCProvider ID: {}".format(
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName, self.OIDCProvider_id))
        testcases = 0
        failures = list()
        for combination in self.create_path_combinations(
            ...
            testcase = {
                ...
                "cluster ID: {}, appService ID: {}, "
                "appEndpointNa ID: {}, OIDCProvider ID: {}"
                ...
                "OIDCProviderID": combination[5]
            }
            if not (combination[0] == self.organisation_id and
                    combination[1] == self.project_id and
                    combination[2] == self.cluster_id and
                    combination[3] == self.app_service_id and
                    combination[4] == self.appEndpointName and
                    combination[5] == self.OIDCProvider_id):
                if (combination[0] == "" or combination[1] == "" or
                    ...
                    testcase["expected_error"] = "404 page not found"
                        ...
                        type(combination[4]), type(combination[5])]):
                ...
                elif combination[3] != self.app_service_id and not \
    ...
    def test_payload(self):
        testcases = list()
        for k in self.expected_res["data"][1]:
            if k in []:
                continue
            ...
            for v in [
                ...
                if k in ["rolesClaim", "isDefault", "providerId", "userPrefix",
                         "usernameClaim", "discoveryUrl", "register"] and v is None:
                    continue

                test_data = {
                    "description": "Testing `{}` with val: `{}` of {}".format(k, v, type(v)),
                    k: v
                }
                if k in ["issuer"] and v in ["", None]:
                    ...
                    test_data["expected_error"] = {
                        ...
                        "httpStatusCode": 422,
                        "message": "OIDC Provider invalid {}".format(k)
                    }
                elif k in ["discoveryUrl", "issuer"]:
                    test_data["expected_status_code"] = 422
                    test_data["expected_error"] = {
                        "code": 422,
                        "hint": "Please review your request and ensure that "
                    ...
                    test_data["expected_error"] = {
                        ...
                        "hint": "Please review your request and ensure that all "
                                "required parameters are correctly provided.",
                        "httpStatusCode": 422,
                        "message": "OIDC provider invalid client id"
                    }
                elif k in ["isDefault", "register"] or \
                    (k in ["clientId", "rolesClaim", "issuer", "providerId",
                           "userPrefix", "usernameClaim", "discoveryUrl"]
        ...
        for testcase in testcases:
            ...
            for k, v in testcase.items():
                if k not in ['description', 'expected_status_code',
                             'expected_error', 'isDefault', 'providerId']:
                    param[k] = v
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.update_app_endpoint_o_i_d_c_provider, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                self.OIDCProvider_id,
                self.expected_res["data"][0]["issuer"],
                self.expected_res["data"][0]["clientId"]
            )
        ]]
