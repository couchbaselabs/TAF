...
class DeleteOidcProviders(GetOidcProviders):

    def setUp(self, nomenclature="ConnectOIDCProviders_DELETE"):
        GetOidcProviders.setUp(self, nomenclature)

    def tearDown(self):
        super(DeleteOidcProviders, self).tearDown()
    ...
    def test_api_path(self):
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis.delete_app_endpoint_o_i_d_c_provider(
            ...
            if self.validate_testcase(result, [202], testcase, failures):
                ...
                self.OIDCProvider_id = self.create_app_endpoint_oidc_Provider_to_be_tested(
                    self.app_service_id,
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            testcase = {
                ...
                "cluster ID: {}, appService ID: {}, "
                "appEndpointName: {}, OIDCProvider ID: {}"
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.delete_app_endpoint_o_i_d_c_provider, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                self.OIDCProvider_id
            )
