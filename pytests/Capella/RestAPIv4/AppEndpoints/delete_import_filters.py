...
class DeleteImportFilter(GetAppEndpoints):

    def setUp(self, nomenclature="ImportFilter_Delete"):
        GetAppEndpoints.setUp(self, nomenclature)

    def tearDown(self):
        super(DeleteImportFilter, self).tearDown()
    ...
    def test_api_path(self):
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis.delete_import_filter(
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.delete_import_filter, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
