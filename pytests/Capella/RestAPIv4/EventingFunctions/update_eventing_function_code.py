...
class UpdateEventingFunctionCode(EventingFunctionBase):

    def setUp(self, nomenclature="EventingFunctions_UpdateCode"):
        EventingFunctionBase.setUp(self, nomenclature, create_function=True)

    def test_api_path(self):
        testcases = [
            {
                "description": "Update eventing function code with valid path params"
            }, {
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/eventingFunctions/{}/code/update",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Update code with non-hex organizationID",
                "invalid_organizationID": self.replace_last_character(
                    self.organisation_id, non_hex=True),
                "expected_status_code": 400,
                "expected_error": self.expected_invalid_uuid_error()
            }, {
                "description": "Update code with non-hex projectID",
                "invalid_projectID": self.replace_last_character(
                    self.project_id, non_hex=True),
                "expected_status_code": 400,
                "expected_error": self.expected_invalid_uuid_error()
            }, {
                "description": "Update code with non-hex clusterID",
                "invalid_clusterID": self.replace_last_character(
                    self.cluster_id, non_hex=True),
                "expected_status_code": 400,
                "expected_error": self.expected_invalid_uuid_error()
            }, {
                "description": "Update code for non-existent function",
        ...
        for testcase in testcases:
            ...
            result = self.api_call_with_retry(
                self.capellaAPI.cluster_ops_apis.update_eventing_function_code,
    ...
    def test_payload(self):
        testcases = [
            {
                "desc": "Update with valid JavaScript code",
                "code": ("function OnUpdate(doc, meta, xattrs) { return; }\n"
                         "function OnDelete(meta, options) { return; }")
            }, {
                "desc": "Update with empty code",
                "code": "",
                "expected_status_code": [400, 422],
                "expected_error": ""
            }, {
                "desc": "Update with non-JavaScript content",
                "code": '{"key": "value"}',
                "expected_status_code": [400, 422],
                "expected_error": ""
            }
        ...
        for testcase in testcases:
            result = self.api_call_with_retry(
                self.capellaAPI.cluster_ops_apis.update_eventing_function_code,
                self.organisation_id, self.project_id, self.cluster_id,
                self.function_name, testcase["code"])
            self.validate_testcase(result, [204], testcase, failures,
                                   payloadTest=True)
        if failures:
    ...
    def test_query_parameters(self):
        testcases = [
            {
                "description": "Update code with valid path params",
                "organizationID": self.organisation_id,
                "projectID": self.project_id,
                "clusterID": self.cluster_id,
                "functionName": self.function_name
            }, {
                "description": "Update code with empty organizationID",
                "organizationID": "",
                "projectID": self.project_id,
                "clusterID": self.cluster_id,
                "functionName": self.function_name,
                ...
                "description": "Update code with wrong organizationID",
