...
from pytests.Capella.RestAPIv4.GSI.get_index_properties import GetIndex


class GetBuildStatus(GetIndex):

    def setUp(self, nomenclature="GSI_GET"):
        GetIndex.setUp(self, nomenclature)
        self.expected_res = {
            "status": None
        }

    def tearDown(self):
        super(GetBuildStatus, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/queryService/indexBuildStatus",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/queryService/indexBuildStatu",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/queryService/indexBuildStatus/indexBuildStatu",
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.index_build_status_endpoint =\
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.index_build_status(
    ...
    def test_query_parameters(self):
        self.log.debug(
                ...
                "cluster ID: {}, index Name: {}, bucket Name: {}".format(
                    self.organisation_id, self.project_id, self.cluster_id,
        ...
        for combination in self.create_path_combinations(
            ...
            testcase = {
                "description": "organization ID: {}, project ID: {}, "
                               "cluster ID: {}, indexName: {}, bucketName: {}"
            ...
            result = self.capellaAPI.cluster_ops_apis.index_build_status(
                ...
                testcase["clusterID"], testcase["indexName"],
                **kwarg)
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
                result = self.capellaAPI.cluster_ops_apis.index_build_status(
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.index_build_status, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.indexName
            )
        ]]
