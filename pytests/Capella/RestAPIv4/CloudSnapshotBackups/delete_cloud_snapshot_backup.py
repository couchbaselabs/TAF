...
class DeleteCloudSnapshotBackup(UpdateCloudSnapshotBackupRetention):

    def setUp(self, nomenclature="Cloud_Snapshot_Backup_Delete"):
        UpdateCloudSnapshotBackupRetention.setUp(self, nomenclature)

    def tearDown(self):
        super(DeleteCloudSnapshotBackup, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            ...
            {
                "description": "Delete cloud snapshot backup with non-hex organizationID",
                ...
                "description": "Delete cloud snapshot backup with non-hex projectID",
                ...
                "description": "Delete cloud snapshot backup with non-hex clusterID",
                ...
                "description": "Delete cloud snapshot backup with non-hex backupID",
        ...
        for testcase in testcases:
            ...
            result = self.api_call_with_retry(
                self.capellaAPI.cluster_ops_apis.delete_cloud_snapshot_backup,
