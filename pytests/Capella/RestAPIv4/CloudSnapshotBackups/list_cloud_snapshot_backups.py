...
class ListCloudSnapshotBackups(CloudSnapshotBackupBase):

    def setUp(self, nomenclature="Cloud_Snapshot_Backups_List"):
        CloudSnapshotBackupBase.setUp(self, nomenclature)

    def tearDown(self):
        super(ListCloudSnapshotBackups, self).tearDown()
        ...
        testcases = [
            {
                ...
                "description": "List cloud snapshot backups with non-hex organizationID",
                ...
                "description": "List cloud snapshot backups with non-hex projectID",
                ...
                "description": "List cloud snapshot backups with non-hex clusterID",
