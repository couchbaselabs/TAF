...
class ListCloudSnapshotRestores(CloudSnapshotBackupBase):

    def setUp(self, nomenclature="Cloud_Snapshot_Restores_List"):
        CloudSnapshotBackupBase.setUp(self, nomenclature)

    def tearDown(self):
        super(ListCloudSnapshotRestores, self).tearDown()

    def test_api_path(self):
        testcases = [
            {"description": "List cloud snapshot restores with valid path"},
            {
                "description": "List cloud snapshot restores with non-hex organizationID",
                ...
                "description": "List cloud snapshot restores with non-hex projectID",
                ...
                "description": "List cloud snapshot restores with non-hex clusterID",
        ...
        for testcase in testcases:
            ...
            result = self.api_call_with_retry(
                self.capellaAPI.cluster_ops_apis.list_cloud_snapshot_restores,
