...
class DownloadCategories(GetCluster):
        ...
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/billing/download",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/billing/downloak",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/billing/download/invalid",
    ...
    def test_download_categories_in_csv_date_ranges(self):
        today = datetime.now()
        date_fmt = "%Y-%m-%d"
        testcases = [
            {
    ...
    def test_download_categories_in_csv_negative_dates(self):
        today = datetime.now()
        date_fmt = "%Y-%m-%d"
        testcases = [
            {
    ...
    def test_download_categories_in_csv_individual_categories(self):
        today = datetime.now()
        date_fmt = "%Y-%m-%d"
        all_categories = [
    ...
    def test_download_categories_in_csv_random_category_combos(self):
        today = datetime.now()
        date_fmt = "%Y-%m-%d"
        testcases = [
            {
    ...
    def test_download_categories_in_csv_all_categories(self):
        today = datetime.now()
        date_fmt = "%Y-%m-%d"
        all_categories = [
            "operationalComputeAndStorage",
