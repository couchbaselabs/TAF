...
class ListEndpoints(GetPrivateEndpointService):
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/privateEndpointService/endpoint",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/privateEndpointService/endpoints/endpoint",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.list_private_networks_endpoint = \
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.list_private_endpoint(
            ...
            self.capellaAPI.cluster_ops_apis.list_private_networks_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/privateEndpointService/endpoints"
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.list_private_endpoint, (
                self.organisation_id, self.project_id, self.cluster_id
            )
        ]]
