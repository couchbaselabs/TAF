...
class PauseAppServiceLogStreaming(GetLogStreaming):

    def setUp(self, nomenclature="PauseAppServiceLogStreaming_DELETE"):
        GetLogStreaming.setUp(self, nomenclature)

    def tearDown(self):
        print("********** do nothing **********")
    #    super(PauseAppServiceLogStreaming, self).tearDown()

    def test_api_pause_app_service_log_streaming_path(self):
        testcases = [
            {
