...
from pytests.Capella.RestAPIv4.AppService.get_app_service \
    import GetAppService


class GetAppEndpointsLogStreamingConfiguration(GetAppService):

    def setUp(self, nomenclature="AppEndpointsLogStreamingConfiguration_GET"):
    ...
    def tearDown(self):
        print("********** do nothing **********")
    #    super(GetAppEndpointsLogStreamingConfiguration, self).tearDown()

    def test_api_app_endpoints_log_streaming_configuration_path(self):
        testcases = [
            {
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.get_app_endpoint_log_streaming_configuration, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
