...
class GetAuditLog(GetCluster):

    def setUp(self, nomenclature="AuditLogs_Get"):
        ...
        self.log.info("Creating AuditLog")
        res = self.capellaAPI.cluster_ops_apis.update_audit_log(
        ...
        if res.status_code != 204:
            ...
            self.tearDown()
            self.fail("Error while creating AuditLog.")
        self.log.info("AuditLog updated successfully.")
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/auditLog",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/auditLo",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/auditLog/auditLo",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.audit_logs_endpoint = \
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.fetch_audit_log_info(
            ...
            self.capellaAPI.cluster_ops_apis.audit_logs_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/auditLog"
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            result = self.capellaAPI.cluster_ops_apis.fetch_audit_log_info(
                ...
                testcase["clusterID"], testcase["auditlogID"], **kwarg)
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
                result = self.capellaAPI.cluster_ops_apis.fetch_audit_log_info(
                    testcase["organizationID"], testcase["projectID"],
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.fetch_audit_log_info, (
                self.organisation_id, self.project_id, self.cluster_id,
            )
        ]]
