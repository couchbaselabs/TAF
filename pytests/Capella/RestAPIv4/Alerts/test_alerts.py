...
class TestAlert(GetAlert):

    def setUp(self, nomenclature="Alerts_Test"):
        GetAlert.setUp(self, nomenclature)

    def tearDown(self):
        super(TestAlert, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/alertIntegrationTest",
                ...
                "url": "/v4/organizations/{}/projects/{}/fooBar",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/alertIntegrationTest/"
                       "fooBar",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.test_alert_endpoint = \
                    testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis.test_alert(
                org, proj, self.expected_res["config"])
            ...
            self.capellaAPI.cluster_ops_apis.test_alert_endpoint = \
                self.capellaAPI.cluster_ops_apis.alerts_endpoint[:-1] + "Test"
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.test_alert,
            (self.organisation_id, self.project_id, self.expected_res["config"])
        ]]
