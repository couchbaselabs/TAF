...
class GetCloudSnapshotBackupSchedule(GetCluster):
    ...
    def setUp(self, nomenclature="Cloud_Snapshot_Backup_Schedule_Get"):
        ...
        if res.status_code != 204:
            ...
            self.tearDown()
            self.fail("!!!..Cloud snapshot backup schedule creation failed..!!!")
    ...
    def tearDown(self):
        ...
        if res.status_code not in [204, 404]:
            self.log.warning("Cloud snapshot backup schedule cleanup "
                             "failed: {}".format(res.content))
        super(GetCloudSnapshotBackupSchedule, self).tearDown()
    ...
    def test_api_path(self):
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis. \
                get_cloud_snapshot_backup_schedule(
