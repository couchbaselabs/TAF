...
class PostActivationState(GetFreeTier):

    def setUp(self, nomenclature="FreeTier_POST"):
        GetFreeTier.setUp(self, nomenclature)

    def tearDown(self):
        super(PostActivationState, self).tearDown()
        ...
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/freeTier/{}/activationState",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/freeTier/{}/activationStat",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/freeTier/{}/activationState/activationStat",
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis.\
                    free_tier_cluster_activation_state_endpoint = \
                    testcase["url"]
            ...
            result = (self.capellaAPI.cluster_ops_apis.
                      turn_free_tier_cluster_on(
                        organization, project, cluster, False))
        ...
        for testcase in self.v4_RBAC_injection_init([
            ...
            result = (self.capellaAPI.cluster_ops_apis.
                      turn_free_tier_cluster_on(
                        ...
                        self.free_tier_cluster_id, False, header))
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
                result = (self.capellaAPI.cluster_ops_apis.
                          turn_free_tier_cluster_on(
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            result = self.capellaAPI.cluster_ops_apis.turn_free_tier_cluster_on(self.organisation_id, self.project_id, self.free_tier_cluster_id,
                **kwarg)
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
                result = self.capellaAPI.cluster_ops_apis.turn_free_tier_cluster_on(self.organisation_id, self.project_id, self.free_tier_cluster_id,
    ...
    def test_payload(self):
        testcases = list()
        for k in ["turnOnLinkedAppService"]:
            for v in [
        ...
        for testcase in testcases:
            ...
            result = (self.capellaAPI.cluster_ops_apis.
                      turn_free_tier_cluster_on(
                        ...
                        testcase["turnOnLinkedAppService"]))
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
                result = (self.capellaAPI.cluster_ops_apis.
                          turn_free_tier_cluster_on(
