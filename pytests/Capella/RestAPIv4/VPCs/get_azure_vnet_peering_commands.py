...
@author: Created using cbRAT cbFile by Mohsin Ahmed
"""

from pytests.Capella.RestAPIv4.Clusters.get_clusters import GetCluster


class PostNetworkPeerCommand(GetCluster):

    def setUp(self, nomenclature="AzureNetworkPeerCommand_Post"):
        GetCluster.setUp(self, nomenclature)

        self.expected_res = {
            "tenantId": str(self.input.param("azureTenantId", None)),
            ...
            "vnetPeeringServicePrincipal": str(self.input.param("vnetPeeringServicePrincipal", None))
        }

    def tearDown(self):
        self.update_auth_with_api_token(self.curr_owner_key)
        super(PostNetworkPeerCommand, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/networkPeers/networkPeerCommand",
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis.get_azure_vnet_peering_command(
                organization, project, cluster,
                self.expected_res["tenantId"],
                self.expected_res["subscriptionId"],
                self.expected_res["resourceGroup"],
                self.expected_res["vnetId"],
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.get_azure_vnet_peering_command, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.expected_res["tenantId"],
                self.expected_res["subscriptionId"],
                self.expected_res["resourceGroup"],
