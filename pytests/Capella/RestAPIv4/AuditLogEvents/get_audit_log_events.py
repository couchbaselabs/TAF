...
class GetAuditLogEvent(GetCluster):

    def setUp(self, nomenclature="AuditLogEvents_Get"):
        GetCluster.setUp(self, nomenclature)

        self.expected_res = {
            "events": []
        }
        self.log.info("Creating AuditLogEvent")

    def tearDown(self):
        self.update_auth_with_api_token(self.org_owner_key["token"])
        super(GetAuditLogEvent, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/auditLogEvents",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/auditLogEvent",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/auditLogEvents/auditLogEvent",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis.fetch_audit_log_event_info(
            ...
            self.capellaAPI.cluster_ops_apis.audit_log_events_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/auditLogEvents"
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.fetch_audit_log_event_info, (
                self.organisation_id, self.project_id, self.cluster_id,
            )
        ]]
