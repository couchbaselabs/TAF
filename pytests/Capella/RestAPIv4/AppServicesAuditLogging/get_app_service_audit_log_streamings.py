        ...
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/auditLogStreaming",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/auditLogStreamin",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/auditLogStreaming/auditLogStreamin",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis\
                    .app_svc_audit_log_streaming_endpoint = testcase["url"]
            ...
            result = (self.capellaAPI.cluster_ops_apis
                      .fetch_app_service_audit_log_streaming_info(
    ...
    def test_authorization(self):
        ...
        for role in self.api_keys:
            ...
            if not any(element in [
                 ...
                 "projectViewer", "projectDataReaderWriter"
