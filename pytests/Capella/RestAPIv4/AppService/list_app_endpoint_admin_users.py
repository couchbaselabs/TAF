...
class ListAdminUsers(GetAppEndpoints):

    def setUp(self, nomenclature="AppService_LIST"):
    ...
    def tearDown(self):
        super(ListAdminUsers, self).tearDown()
    ...
    def test_api_path(self):
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/adminUsers",
                ...
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/adminUser",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/adminUsers/adminUser",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_admin_user(
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_admin_user(
                    organization, project, cluster, appService, appEndpointName)
            self.capellaAPI.cluster_ops_apis.admin_users_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/appservices/{}/appEndpoints/{}/adminUsers"
    ...
    def test_query_parameters(self):
        ...
        for combination in self.create_path_combinations(
            ...
            result = self.capellaAPI.cluster_ops_apis.list_app_endpoint_admin_user(self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName,
                **kwarg)
            if result.status_code == 429:
                self.handle_rate_limit(int(result.headers["Retry-After"]))
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.list_app_endpoint_admin_user, (
                self.organisation_id, self.project_id, self.cluster_id,
                self.app_service_id, self.appEndpointName
            )
        ]]
