...
class AppServiceOff(GetAppService):

    def setUp(self, nomenclature="Switch_App_Service_Off"):
        GetAppService.setUp(self, nomenclature)

    def tearDown(self):
        self.update_auth_with_api_token(self.org_owner_key["token"])
        super(AppServiceOff, self).tearDown()

    def test_api_path(self):
        testcases = [
            {
                "description": "Turn off a valid appService"
            }, {
                ...
                "description": "Switch appService off but with non-hex "
                               "organizationID",
        ...
        for testcase in testcases:
            ...
            if "invalid_organizationID" in testcase:
                ...
                app = testcase["invalid_appServiceId"]
    ...
    def test_multiple_requests_using_API_keys_with_same_role_which_has_access(
            self):
        api_func_list = [[
            self.capellaAPI.cluster_ops_apis.switch_app_service_off,
            (self.organisation_id, self.project_id, self.cluster_id,
             self.app_service_id)
        ]]
