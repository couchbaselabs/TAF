...
class DeletePrivateEndpointService(GetAnalyticsClusters):

    def setUp(self, nomenclature="PrivateEndpointsColumnar_DELETE"):
    ...
    def test_api_path(self):
        ...
        for testcase in testcases:
            ...
            result = self.columnarAPI.disable_private_endpoint_service(
