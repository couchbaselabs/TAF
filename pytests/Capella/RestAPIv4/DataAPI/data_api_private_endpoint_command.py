...
class PostDataAPIEndpointCommand(GetCluster):

    def setUp(self, nomenclature="DataAPI_PrivateEndpointCommand_POST"):
    ...
    def tearDown(self):
        super(PostDataAPIEndpointCommand, self).tearDown()
        ...
        testcases = [
            {
                ...
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpointCommand",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpointComman",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpointCommand/privateEndpointComman",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis\
                    .data_api_private_endpoint_command_endpoint = \
                    testcase["url"]
            ...
            result = (self.capellaAPI.cluster_ops_apis
                      .post_data_api_private_endpoint_command(
            ...
            self.capellaAPI.cluster_ops_apis\
                ...
                "dataAPI/privateEndpointCommand"
        ...
        for combination in self.create_path_combinations(
            ...
            if result.status_code == 429:
                ...
                result = (self.capellaAPI.cluster_ops_apis
                          .post_data_api_private_endpoint_command(
                            testcase["organizationID"], testcase["projectID"],
                            testcase["clusterID"], self.expected_res,
                            **kwarg))
            self.validate_testcase(result, [200], testcase, failures)
