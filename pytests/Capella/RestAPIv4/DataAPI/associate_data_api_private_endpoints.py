...
class PostDataAPIAssociate(GetCluster):
        ...
        if (self.input.param("cluster_template", "AWS_r5_xlarge") ==
            ...
            self.expected_err = {
                ...
                "hint": "Please review your request and ensure that all "
                        "required parameters are correctly provided.",
                "httpStatusCode": 400,
                "message": "Data API isn't enabled for this cluster. Please "
                           "select another cluster."
            }

    def tearDown(self):
        super(PostDataAPIAssociate, self).tearDown()

    def test_api_path(self):
        testcases = [
            {
                "description": "Replace api version in URI",
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpoints/{}/associate",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpoints/{}/associat",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpoints/{}/associate/associat",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis\
                    .associate_data_api_private_endpoint = testcase["url"]
            ...
            self.capellaAPI.cluster_ops_apis.update_data_api(
                organization, project, cluster, True)
            result = self.capellaAPI.cluster_ops_apis\
                .accept_data_api_private_endpoint(
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis\
                    .accept_data_api_private_endpoint(
                        organization, project, cluster, endpoint)
            self.capellaAPI.cluster_ops_apis\
                .associate_data_api_private_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/"\
                "dataAPI/privateEndpoints/{}/associate"
