...
from pytests.Capella.RestAPIv4.DataAPI.\
    associate_data_api_private_endpoints import PostDataAPIAssociate


class PostDataAPIUnassociate(PostDataAPIAssociate):

    def setUp(self, nomenclature="DataAPI_PrivateEndpoints_POST"):
        PostDataAPIAssociate.setUp(self, nomenclature)

    def tearDown(self):
        super(PostDataAPIUnassociate, self).tearDown()

    def test_api_path(self):
        testcases = [
            {
                "description": "Replace api version in URI",
                "url": "/v3/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpoints/{}/unassociate",
                "expected_status_code": 404,
                "expected_error": "<html><head><title>404NotFound</title></head><body><center><h1>404NotFound</h1></center><hr><center>nginx</center></body></html>"
            }, {
                "description": "Replace the last path param name in URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpoints/{}/unassociat",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
                "description": "Add an invalid segment to the URI",
                "url": "/v4/organizations/{}/projects/{}/clusters/{}/dataAPI/privateEndpoints/{}/unassociate/unassociat",
                "expected_status_code": 404,
                "expected_error": "404 page not found"
            }, {
        ...
        for testcase in testcases:
            ...
            if "url" in testcase:
                self.capellaAPI.cluster_ops_apis\
                    .unassociate_data_api_private_endpoint = testcase["url"]
            ...
            result = self.capellaAPI.cluster_ops_apis\
                .delete_data_api_private_endpoint(
            ...
            if result.status_code == 429:
                ...
                result = self.capellaAPI.cluster_ops_apis\
                    .delete_data_api_private_endpoint(
                        organization, project, cluster, endpoint)
            self.capellaAPI.cluster_ops_apis\
                .unassociate_data_api_private_endpoint = \
                "/v4/organizations/{}/projects/{}/clusters/{}/"\
                "dataAPI/privateEndpoints/{}/unassociate"
