...
class ColumnarScalingOperations(ColumnarBaseTest):
    ...
    def test_scale_in_and_scale_out_columnar_instances(self):
        ...
        self.columnar_utils.scale_columnar_instance(self.instance, 5)
        self.columnar_utils.wait_for_instance_scaling_operation_to_complete(
            self.instance)
        # decrease compute units from 5 to 2
        self.columnar_utils.scale_columnar_instance(self.instance, 2)
        self.columnar_utils.wait_for_instance_scaling_operation_to_complete(
            self.instance)
