    ...
    "collections_defn": [
        {
            ...
            "queries": [
                ...
                'SELECT id from {collection} where brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "indexes_base64": [
            ...
            "queries_base64": [
                'SELECT id from {collection} where brand="Nike" AND color="Green" AND size=5 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where brand="Nike" AND color="Green" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where brand="Nike" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "groundTruths":[
                ("idx_1M.ivecs", "1/10"),
                ("idx_2M.ivecs", "2/10"),
        ...
        },
        {
            ...
            "queries": [
                ...
                'SELECT id from {collection} where country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" AND brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10'
                ],
            "indexes_base64": [
            ...
            "queries_base64": [
                'SELECT id from {collection} where country="USA" AND brand="Nike" AND color="Green" AND size=5 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" AND brand="Nike" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10'
                ],
            "groundTruths":[
                ("idx_1M.ivecs", "1/20"),
                ("idx_2M.ivecs", "2/20"),
        ...
        },
        {
            ...
            "queries": [
                ...
                'SELECT id from {collection} where category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" AND country="USA" AND brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" AND country="USA" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "indexes_base64": [
            ...
            "queries_base64": [
                'SELECT id from {collection} where category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" AND size=5 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" AND country="USA" AND brand="Nike" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" AND country="USA" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "groundTruths":[
                ("idx_1M.ivecs", "1/50"),
                ("idx_2M.ivecs", "2/50"),
        ...
        },
        {
            ...
            "queries": [
                ...
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "indexes_base64": [
            ...
            "queries_base64": [
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" AND size=5 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" AND country="USA" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" AND category="Shoes" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where `type`="Casual" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "groundTruths":[
                ("idx_1M.ivecs", "1/100"),
                ("idx_2M.ivecs", "2/100"),
        ...
        },
        {
            ...
            "queries": [
                ...
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "indexes_base64": [
            ...
            "queries_base64": [
                ...
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "groundTruths":[
                ("idx_1M.ivecs", "1/200"),
                ("idx_2M.ivecs", "2/200"),
        ...
        },
        {
            ...
            "queries": [
                ...
                'SELECT id from {collection} where color="Green" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where brand="Nike" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where `type`="Casual" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where review=1 ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where review in [1.0, 2.0] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                ],
            "indexes_base64": [
            ...
            "queries_base64": [
                'SELECT id from {collection} where size=5 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where color="Green" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where brand="Nike" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where country="USA" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where category="Shoes" ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where `type`="Casual" ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
        ...
        },
        {
            ...
            "queries": [
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" AND size=5 ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" AND size in [5,6] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color in ["Green","Red"] AND size in [5,6,7] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand in ["Nike","Adidas"] AND color in ["Green","Red", "Blue"] AND size in [5,6,7,8] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country in ["USA","Canada"] AND brand in ["Nike","Adidas", "Puma"] AND color in ["Green","Red", "Blue","Purple"] AND size in [5,6,7,8,9] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category in ["Shoes","Jeans"] AND country in ["USA","Canada","Australia"] AND brand in ["Nike","Adidas","Puma","Asic"] AND color in ["Green","Red", "Blue","Purple","Pink"] AND size in [5,6,7,8,9,10] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
            ...
            "queries_base64": [
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" AND size=5 ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color="Green" AND size in [5,6] ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand="Nike" AND color in ["Green","Red"] AND size in [5,6,7] ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country="USA" AND brand in ["Nike","Adidas"] AND color in ["Green","Red", "Blue"] AND size in [5,6,7,8] ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category="Shoes" AND country in ["USA","Canada"] AND brand in ["Nike","Adidas", "Puma"] AND color in ["Green","Red", "Blue","Purple"] AND size in [5,6,7,8,9] ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                'SELECT id from {collection} where review=1.0 AND `type`="Casual" AND category in ["Shoes","Jeans"] AND country in ["USA","Canada","Australia"] AND brand in ["Nike","Adidas","Puma","Asic"] AND color in ["Green","Red", "Blue","Purple","Pink"] AND size in [5,6,7,8,9,10] ORDER BY ANN(DECODE_VECTOR(embedding,False) , $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where review=1.0 AND `type` in ["Casual","Formal"] AND category in ["Shoes","Jeans","Shirt"] AND country in ["USA","Canada","Australia","England"] AND brand in ["Nike","Adidas","Puma","Asic","Brook"] AND color in ["Green","Red", "Blue","Purple","Pink","Yellow"] AND size in [5,6,7,8,9,10,11] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where review in [1.0, 2.0] AND `type` in ["Casual","Formal","Sports"] AND category in ["Shoes","Jeans","Shirt","Shorts"] AND country in ["USA","Canada","Australia","England","India"] AND brand in ["Nike","Adidas","Puma","Asic","Brook","Hoka"] AND color in ["Green","Red", "Blue","Purple","Pink","Yellow","Brown"] AND size in [5,6,7,8,9,10,11,12] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where review in [1.0, 2.0, 5.0] AND `type` in ["Casual","Formal","Sports"] AND category in ["Shoes","Jeans","Shirt","Shorts"] AND country in ["USA","Canada","Australia","England","India"] AND brand in ["Nike","Adidas","Puma","Asic","Brook","Hoka"] AND color in ["Green","Red", "Blue","Purple","Pink","Yellow","Brown"] AND size in [5,6,7,8,9,10,11,12] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
                # 'SELECT id from {collection} where review in [1.0, 2.0, 5.0, 10.0] AND `type` in ["Casual","Formal","Sports"] AND category in ["Shoes","Jeans","Shirt","Shorts"] AND country in ["USA","Canada","Australia","England","India"] AND brand in ["Nike","Adidas","Puma","Asic","Brook","Hoka"] AND color in ["Green","Red", "Blue","Purple","Pink","Yellow","Brown"] AND size in [5,6,7,8,9,10,11,12] ORDER BY ANN(embedding, $vector, "{similarity}", {nProbe}) limit 10',
