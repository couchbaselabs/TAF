...
class SteadyStateTests(MagmaBaseTest):
    ...
    def test_history_retention_for_n_upsert_iterations(self):
        ...
        expected_count = ((count) * ((self.num_replicas+1) * self.init_items_per_collection * (self.num_collections-1))) + ((self.num_collections -1) * (self.vbuckets*(self.num_replicas+1)))
    ...
    def test_history_retention_for_n_expiry_iterations(self):
        ...
        + ((self.num_collections -1) * (self.vbuckets*(self.num_replicas+1))) \
