...
class BucketUtils:
    ...
    def create_default_bucket(
            ...
            purge_interval=1, bucket_name="default"):
        ...
        default_bucket = Bucket({Bucket.name: bucket_name,
                                 ...
                                 Bucket.durability_level: bucket_durability,
    ...
    def _wait_warmup_completed(self, servers, bucket, wait_time=300):
        ...
        for server in servers:
            ...
            while time.time() - start < wait_time:
                ...
                try:
                    result = \
                        cbstat_obj.all_stats(bucket.name)["ep_warmup_thread"]
                except:
                    pass
