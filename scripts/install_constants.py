...
NON_ROOT_DOWNLOAD_DIR = {
    "LINUX_DISTROS": "/home/nonroot/",
    "MACOS_VERSIONS": "~/Downloads/",
    "WINDOWS_SERVER": "/cygdrive/c/tmp/"}

DEFAULT_INSTALL_DIR = {
    "LINUX_DISTROS": "/opt/couchbase",
...
DEFAULT_CLI_PATH = {
    "LINUX_DISTROS": DEFAULT_INSTALL_DIR["LINUX_DISTROS"]
                     + "/bin/couchbase-cli",
    "MACOS_VERSIONS": DEFAULT_INSTALL_DIR["MACOS_VERSIONS"]
                      + "/Contents/Resources/couchbase-core/bin/couchbase-cli",
...
PROCESSES_TO_TERMINATE = ["beam.smp", "memcached", "moxi", "vbucketmigrator",
                          "couchdb", "epmd", "memsup", "cpu_sup",
                          "goxdcr", "erlang", "eventing", "erl", "godu",
